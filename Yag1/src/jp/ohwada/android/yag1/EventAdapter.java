...
public class EventAdapter extends ArrayAdapter<EventRecord> 
{
	...
	public View getView( int position, View convertView, ViewGroup parent ) {
		...
		if ( view == null ) {
			...
			// save 
			h = new EventHolder(); 
			h.tv_event = (TextView) view.findViewById( R.id.event_row_textview_event ); 
			h.tv_place = (TextView) view.findViewById( R.id.event_row_textview_place );
			h.tv_start = (TextView) view.findViewById( R.id.event_row_textview_start );
			h.tv_end = (TextView) view.findViewById( R.id.event_row_textview_end );
			h.tv_bar = (TextView) view.findViewById( R.id.event_row_textview_bar );
			view.setTag( h ); 
		...
		// set value
		h.tv_event.setText( r.event_label ) ;
		h.tv_place.setText( r.place_label ) ;
