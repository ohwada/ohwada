package jp.ohwada.android.preferenceactivitysample;
...
public class SettingActivity extends PreferenceActivity {
	...
	private RingtonePreference mRingtonePreference1 = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRingtonePreference1 = (RingtonePreference) findPreference( "preference_key_ringtone_1" );
        mRingtonePreference1.setOnPreferenceChangeListener(
        		new OnPreferenceChangeListener() {        	
        	@Override
        	public boolean onPreferenceChange(Preference p, Object o) {
        ...
        mRingtonePreference1.setSummary( title );  
	}
