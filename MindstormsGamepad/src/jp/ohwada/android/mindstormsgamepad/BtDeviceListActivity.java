...
public class BtDeviceListActivity extends Activity {
	...
	private static final boolean D = Constant.BT_DEBUG_LOG_DEVICE;
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        if (pairedDevices.size() > 0) {
            ...
            String noDevices = getResources().getText(R.string.list_none_paired).toString();
    ...
    private void doDiscovery() {
        ...
        setTitle(R.string.list_scanning);
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            if ( length >= MAC_ADDR_OFFSET ) {
				...
				log_d( "address; "  + address );
            } else {
            	log_d( "not get address" );
            }
			// Create the result Intent and include the MAC address
			Intent intent = new Intent();
			intent.putExtra( BT_EXTRA_DEVICE_ADDRESS, address );
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // When discovery is finished, change the Activity title
                ...
                setTitle(R.string.list_select_device);
                if (mNewDevicesArrayAdapter.getCount() == 0) {
                    String noDevices = getResources().getText(R.string.list_none_found).toString();
