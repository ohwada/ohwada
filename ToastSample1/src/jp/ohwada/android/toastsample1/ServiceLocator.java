...
package jp.ohwada.android.toastsample1;
...
final class ServiceLocator {
	...
	private static final Object getServiceStubInternal(String serviceName,
		...
		Object binder = getBinderInternal(serviceName);
	...
	// 2013-03-01 K.OHWADA
	public static final IBinder getBinder(String serviceName) {
		IBinder binder = null;
		try {
			binder = (IBinder) getBinderInternal(serviceName);
		} catch (Exception e) {
			Log.e("ServiceLocator", "", e);
		}
		return binder;
	...
	// 2013-03-01 K.OHWADA
	private static final Object getBinderInternal(String serviceName) throws Exception {
