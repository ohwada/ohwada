...
public class MainActivity extends Activity {
	...
	private void getPreferences() {
		...
		boolean switch_1 = preference.getBoolean( "preference_key_switch_1" , false );
        String edittext_1 = preference.getString( "preference_key_edittext_1", "" );
        String list_1 = preference.getString( "preference_key_list_1", "" );

        String multiselectlist_1 = mPreference.getMultiSelectListValue( "preference_key_multiselectlist_1" );
		...
		String msg = "";
			msg += "EditText 1 : " + edittext_1 + LF;
			msg += "CheckBox 1 : " + checkbox_1 + LF;
			msg += "Switch 1 : " + switch_1 + LF;
			msg += "List 1 : " + list_1 + LF;
			msg += "MultiSelectList 1 : " + LF;
			msg += multiselectlist_1 + LF;
			msg += "Ringtone 1 : " + mRingtone1_title + " " + mRingtone1 + LF;
			msg += "Category 1 CheckBox 1 : " + category_1_checkbox_1 + LF;
			msg += "Screen 1 CheckBox 1 : " + screen_1_checkbox_1 + LF;
