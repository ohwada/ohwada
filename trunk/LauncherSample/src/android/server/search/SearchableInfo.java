...
public final class SearchableInfo implements Parcelable {
    ...
    private SearchableInfo(Context activityContext, AttributeSet attr, final ComponentName cName) {
        ...
        mSearchButtonText = a.getResourceId(
                R.styleable.Searchable_android_searchButtonText, 0);
        mSearchInputType = a.getInt(R.styleable.Searchable_android_inputType, 
                InputType.TYPE_CLASS_TEXT |
                InputType.TYPE_TEXT_VARIATION_NORMAL);
        mSearchImeOptions = a.getInt(R.styleable.Searchable_android_imeOptions, 
                EditorInfo.IME_ACTION_SEARCH);
        mIncludeInGlobalSearch = a.getBoolean(
                R.styleable.Searchable_android_includeInGlobalSearch, false);
        mQueryAfterZeroResults = a.getBoolean(
                R.styleable.Searchable_android_queryAfterZeroResults, false);
        mAutoUrlDetect = a.getBoolean(
                R.styleable.Searchable_android_autoUrlDetect, false);

        mSettingsDescription = a.getString(
                R.styleable.Searchable_android_searchSettingsDescription);
        mSuggestAuthority = a.getString(
                R.styleable.Searchable_android_searchSuggestAuthority);
        mSuggestPath = a.getString(
                R.styleable.Searchable_android_searchSuggestPath);
        mSuggestSelection = a.getString(
                R.styleable.Searchable_android_searchSuggestSelection);
        mSuggestIntentAction = a.getString(
                R.styleable.Searchable_android_searchSuggestIntentAction);
        mSuggestIntentData = a.getString(
                R.styleable.Searchable_android_searchSuggestIntentData);
        mSuggestThreshold = a.getInt(
                R.styleable.Searchable_android_searchSuggestThreshold, 0);

        mVoiceSearchMode = 
            a.getInt(R.styleable.Searchable_android_voiceSearchMode, 0);
        // TODO this didn't work - came back zero from YouTube
        mVoiceLanguageModeId = 
            a.getResourceId(R.styleable.Searchable_android_voiceLanguageModel, 0);
        mVoicePromptTextId = 
            a.getResourceId(R.styleable.Searchable_android_voicePromptText, 0);
        mVoiceLanguageId = 
            a.getResourceId(R.styleable.Searchable_android_voiceLanguage, 0);
        mVoiceMaxResults = 
    ...
    public static class ActionKeyInfo implements Parcelable {
        ...
        public ActionKeyInfo(Context activityContext, AttributeSet attr) {
            ...
            mQueryActionMsg = a.getString(
                    R.styleable.SearchableActionKey_android_queryActionMsg);
            mSuggestActionMsg = a.getString(
                    R.styleable.SearchableActionKey_android_suggestActionMsg);
            mSuggestActionMsgColumn = a.getString(
                    R.styleable.SearchableActionKey_android_suggestActionMsgColumn);
            a.recycle();
