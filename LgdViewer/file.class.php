...
{
	$this->delete_files_in_dir( $this->config->DIR_JSON_LIST_SUMMARY, $this->config->LIMIT_JSON_LIST_SUMMARY ); 
	$this->delete_files_in_dir( $this->config->DIR_JSON_LIST_DETAIL, $this->config->LIMIT_JSON_LIST_DETAIL ); 
	$this->delete_files_in_dir( $this->config->DIR_JSON_NODE, $this->config->LIMIT_JSON_NODE ); 
	$this->delete_files_in_dir( $this->config->DIR_NODE_LIST, $this->config->LIMIT_NODE_LIST ); 
	$this->delete_files_in_dir( $this->config->DIR_NODE, $this->config->LIMIT_NODE ); 
	$this->delete_files_in_dir( $this->config->DIR_ONTOLOGY, $this->config->LIMIT_ONTOLOGY); 		
}

function delete_files_in_dir( $dir, $limit )
{
	$files = $this->get_files( $dir );
